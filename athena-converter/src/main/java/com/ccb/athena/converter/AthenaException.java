...
public class AthenaException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3736630834268485151L;
     ...
     */
    public AthenaException(String s) {
        this(s, null, null);
    }
     ...
     */
    public AthenaException(String s, Object target) {
     ...
     * @param target The target of the exception
     */
    public AthenaException(Throwable cause, Object target) {
     ...
     * @param cause the wrapped exception
     */
    public AthenaException(String s, Throwable cause) {
        this(s, cause, null);
    }
     ...
     * @param target The target of the exception
     */
    public AthenaException(String s, Throwable cause, Object target) {
        super(s, cause);
    }
