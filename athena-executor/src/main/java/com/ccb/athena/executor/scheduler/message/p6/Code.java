...
public class Code {
	 ...
	 * ASCII���Ӧ��
	 */
	private static final String[] ASCII = { "NUL", /* ASCII 0 0x00 "Null" */
	 ...
	 * EBCDIC���Ӧ��
	 */
	public static final String[] EBCDIC = { "NUL", /* EBCDIC 0 0x00 "Null" */
	...
	/* 112 */-105, -104, -103, -94, -93, -92, -91, -90, -89, -88, -87, -64, 79, -48, 63, 7,
	 ...
	 * �ֽ�����EBCDIC->ASCIIת������
	 */
	public static byte[] EBCDICToASCII(byte[] ebcdic, int length) {
